Rails.application.routes.draw do
  ...
  get 'search_vakil/vakil_list'

  get 'search_vakil/search_by_city'

  get 'search_vakil/search_by_service'

  get 'search_vakil/search_by_city_and_service'
